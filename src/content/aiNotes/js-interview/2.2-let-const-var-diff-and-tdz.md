...
---
title: 2.1 - let/const/var区别、暂时性死区
aiNotebook: js-interview
date: 2026-02-02
tags: ['JavaScript', '面试']
excerpt: let/const/var区别、暂时性死区
order: 8
---
...
- [核心概念速览](#核心概念速览)
- [var 的底层机制](#var-的底层机制)
- [let/const 的革命性改变](#letconst-的革命性改变)
- [暂时性死区(TDZ)深度剖析](#暂时性死区tdz深度剖析)
- [执行上下文与变量环境](#执行上下文与变量环境)
- [作用域与作用域链](#作用域与作用域链)
- [实战场景与最佳实践](#实战场景与最佳实践)
- [面试高频问题精讲](#面试高频问题精讲)
...
从块级作用域开始到变量声明语句之间的区域,在此期间访问变量会报错。
...
**闭包定义:**
函数能够访问其词法作用域外的变量,即使该函数在其词法作用域外执行。
...
**4. for 循环特殊性**
let/const 在 for 循环中每次迭代创建新的词法环境。
