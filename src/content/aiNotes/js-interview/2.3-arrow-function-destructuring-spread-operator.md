...
---
title: 2.1 - 箭头函数、解构赋值、扩展运算符
aiNotebook: js-interview
date: 2026-02-03
tags: ['JavaScript', '面试']
excerpt: 箭头函数、解构赋值、扩展运算符
order: 9
---
...
- [一、箭头函数 (Arrow Function)](#一箭头函数-arrow-function)
  - [1.1 基本语法与使用](#11-基本语法与使用)
  - [1.2 this 绑定机制深度剖析](#12-this-绑定机制深度剖析)
  - [1.3 箭头函数与普通函数的本质区别](#13-箭头函数与普通函数的本质区别)
  - [1.4 使用场景与最佳实践](#14-使用场景与最佳实践)
  - [1.5 常见陷阱与面试题](#15-常见陷阱与面试题)
- [二、解构赋值 (Destructuring)](#二解构赋值-destructuring)
  - [2.1 数组解构原理](#21-数组解构原理)
  - [2.2 对象解构原理](#22-对象解构原理)
  - [2.3 默认值机制](#23-默认值机制)
  - [2.4 高级应用场景](#24-高级应用场景)
  - [2.5 性能与边界情况](#25-性能与边界情况)
- [三、扩展运算符 (Spread/Rest)](#三扩展运算符-spreadrest)
  - [3.1 展开运算符原理](#31-展开运算符原理)
  - [3.2 剩余参数原理](#32-剩余参数原理)
  - [3.3 深拷贝与浅拷贝](#33-深拷贝与浅拷贝)
  - [3.4 实战应用场景](#34-实战应用场景)
  - [3.5 性能考量](#35-性能考量)
- [四、综合实战案例](#四综合实战案例)
- [五、面试高频题解析](#五面试高频题解析)
